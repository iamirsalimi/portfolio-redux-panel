                    ...
                    <ul className="space-y-2 font-medium">
                        {links.map(link => (
                            <li onClick={() => setShowPanel(false)}>
                                <NavLink to={`/${link.title === 'Personal Informations' ? '' : link.title}`} className="flex items-center transition-colors duration-200 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-black/20 group">
                                    {link.svg}
